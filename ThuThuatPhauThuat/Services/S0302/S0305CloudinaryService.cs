...
{
    public class S0305CloudinaryService : IS0305CloudinaryService
    {
        private readonly ILogger<S0305CloudinaryService> _logger;
        private readonly Cloudinary _cloudinary;

        public S0305CloudinaryService(ILogger<S0305CloudinaryService> logger, IConfiguration config)
        {
