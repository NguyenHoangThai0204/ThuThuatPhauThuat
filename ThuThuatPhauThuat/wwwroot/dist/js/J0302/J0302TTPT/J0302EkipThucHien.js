// =========================================================================
// HÀM TIỆN ÍCH TẢI VÀ CHUẨN HÓA DỮ LIỆU (TỪ CONTEXT CỦA NGƯỜI DÙNG)
// =========================================================================

/**
 * Chuẩn hóa dữ liệu mảng, thêm trường 'alias' (viết tắt) và lọc bản ghi active.
 * @param {Array<object>} data - Dữ liệu mảng đầu vào.
 * @param {string} tenField - Tên trường chứa tên/tiêu đề (mặc định 'ten').
 * @param {string} viettatField - Tên trường chứa viết tắt (mặc định 'viettat').
 * @returns {Array<object>} Dữ liệu đã chuẩn hóa.
 */
...
// Khởi chạy
const IDPhieuTTPT_HienTai = 1; // <--- CẦN LẤY ID THỰC TẾ TỪ URL/SESSION/VIEWDATA
